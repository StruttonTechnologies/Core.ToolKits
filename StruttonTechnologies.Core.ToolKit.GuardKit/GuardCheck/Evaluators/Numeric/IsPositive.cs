...
namespace StruttonTechnologies.Core.ToolKit.GuardKit
{
    ...
    {
        /// <summary>
        /// Evaluates whether the provided numeric value is positive (greater than zero).
        /// </summary>
        /// <typeparam name="T">
        ...
        /// </param>
        /// <returns>
        /// A guard continuation that can apply a behavior when the value is positive.
        /// </returns>
        public static GuardCondition<T> IsPositive<T>(T value)
            where T : INumber<T>
        {
        ...
        /// <summary>
        /// Evaluates whether the selected numeric value from the provided object is positive (greater than zero).
        ...
        /// </param>
        /// <returns>
        /// A guard continuation that can apply a behavior when the selected value is positive.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// Thrown when <paramref name="selector"/> is <see langword="null"/>.
        /// </exception>
        public static GuardCondition<TObject> IsPositive<TObject, TValue>(TObject? value, Func<TObject, TValue> selector)
            where TObject : class
