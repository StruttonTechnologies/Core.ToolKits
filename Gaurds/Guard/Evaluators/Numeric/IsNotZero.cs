...
namespace StruttonTechnologies.Core.ToolKit.Guards
{
    ...
    {
        /// <summary>
        /// Evaluates whether the provided numeric value is not zero.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// </param>
        /// <returns>
        /// A guard continuation that can apply a behavior when the value is not zero.
        /// </returns>
        public static GuardCondition<T> IsNotZero<T>(T value)
            where T : INumber<T>
        {
        ...
        /// <summary>
        /// Evaluates whether the selected numeric value from the provided object is not zero.
        ...
        /// </param>
        /// <returns>
        /// A guard continuation that can apply a behavior when the selected value is not zero.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// Thrown when <paramref name="selector"/> is <see langword="null"/>.
        /// </exception>
        public static GuardCondition<TObject> IsNotZero<TObject, TValue>(TObject? value, Func<TObject, TValue> selector)
            where TObject : class
