...
namespace StruttonTechnologies.Core.ToolKit.Guards
{
    ...
    {
        /// <summary>
        /// Evaluates whether the provided numeric value is zero.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// </param>
        /// <returns>
        /// A guard continuation that can apply a behavior when the value is zero.
        /// </returns>
        public static GuardCondition<T> IsZero<T>(T value)
            where T : INumber<T>
        {
        ...
        /// <summary>
        /// Evaluates whether the selected numeric value from the provided object is zero.
        ...
        /// </param>
        /// <returns>
        /// A guard continuation that can apply a behavior when the selected value is zero.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// Thrown when <paramref name="selector"/> is <see langword="null"/>.
        /// </exception>
        public static GuardCondition<TObject> IsZero<TObject, TValue>(TObject? value, Func<TObject, TValue> selector)
            where TObject : class
