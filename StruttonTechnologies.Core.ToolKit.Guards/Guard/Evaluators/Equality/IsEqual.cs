namespace StruttonTechnologies.Core.ToolKit.Guards
{
    ...
    {
        /// <summary>
        /// Evaluates whether the provided value is equal to the comparison value.
        /// </summary>
        /// <typeparam name="T">
        ...
        /// </param>
        /// <returns>
        /// A guard continuation that can apply a behavior when the values are equal.
        /// </returns>
        public static GuardCondition<T> IsEqual<T>(T? value, T? comparison)
        {
            return new GuardCondition<T>(value, EqualityComparer<T>.Default.Equals(value, comparison));
        }

        /// <summary>
        /// Evaluates whether the selected value from the provided object is equal to the comparison value.
        ...
        /// </param>
        /// <returns>
        /// A guard continuation that can apply a behavior when the selected value equals the comparison value.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        /// Thrown when <paramref name="selector"/> is <see langword="null"/>.
        /// </exception>
        public static GuardCondition<TObject> IsEqual<TObject, TValue>(TObject? value, Func<TObject, TValue> selector, TValue? comparison)
            where TObject : class
        {
