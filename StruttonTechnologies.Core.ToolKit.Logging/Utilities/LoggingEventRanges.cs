...
{
    /// <summary>
    /// Defines recommended event identifier ranges by concern.
    /// </summary>
    public static class LoggingEventRanges
    {
        ...
        public const int ExceptionsMinimum = 1700;
        public const int ExceptionsMaximum = 1799;
    }
}
